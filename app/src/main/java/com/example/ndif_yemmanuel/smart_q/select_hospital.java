                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            while(index[0] <array.length())
                            {
                                ...
                                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(select_hospital.this, R.layout.hospital_listview, R.id.list, hospital_list);
                            ...
                            simpleList.setOnItemClickListener(new AdapterView.OnItemClickListener(){
                                ...
                                public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                                    Intent myIntent = new Intent(select_hospital.this, maitama_consult.class);
